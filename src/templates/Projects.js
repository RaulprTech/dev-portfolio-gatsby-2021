    ...
    <div>
      <header className="py-12 border-purple-500 border-solid border-t-8">
        <div className="max-w-4xl mx-auto">
          <Link to="/" className="uppercase underline text-pnk-500">
            Regresar al inicio
          </Link>
            ...
            <li className="bg-white shadow mt-4 flex" key={index}>
              ...
              <div className="flex items-center flex-1 p-8">
                <div className="flex-1">
                  ...
                  {proyect.description && (
                    <span className="inline-block p-2 radius bg-purple-100 text-purple-700 mb-3">
                      {proyect.description}
                    </span>
                  )}
                  <div className="flex-1">
                    {proyect.tecnologys.map(tech => (
                      <span
                        key={tech}
                        className="inline-bock p-2 text-lg bg-blue-100 text-blue-700 mt-4 mr-5"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex-1">
                    {proyect.git && (
                      <a
                        ...
                        className="btn inline-block mt-5 mr-4"
                      >
                        Ver en Git
                      </a>
                    )}
